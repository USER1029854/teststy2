...
contract DecompiledContract {
    ...
    /// @custom:selector    0x2a1e90ef
    /// @custom:signature   Unresolved_2a1e90ef(address arg0, uint256 arg1, uint256 arg2) public payable
    /// @param              arg0 ["address", "uint160", "bytes20", "int160"]
    /// @param              arg1 ["uint256", "bytes32", "int256"]
    /// @param              arg2 ["uint256", "bytes32", "int256"]
    function Unresolved_2a1e90ef(address arg0, uint256 arg1, uint256 arg2) public payable {
        require(arg0 == (address(arg0)));
        address var_a = msg.sender;
        require(bytes1(storage_map_g[var_a]), "Only caller can call this function");
        var_a = arg1;
        storage_map_g[var_a] = arg2;
        var_a = arg1;
        storage_map_g[var_a] = 0x01 | (uint248(storage_map_g[var_a]));
    }
